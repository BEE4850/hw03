...
* Problem 1 is worth 4 points.
* Problem 2 is worth 9 points.
...
Develop an autoregressive (AR) model for the weather-related variability in the Norfolk tide gauge. Make sure to include your logic or exploratory analysis used in determining the model specification. You do not need to fit this model, but write out the specification that you've decided on.
...
Now redo Problem 2.2 but with an AR(1) model for the residuals. Does this look like a better probability model? Did your model parameter estimates change? If so, what changed about your conclusion(s) about the relationship between global mean temperture increases and global mean sea level rise?
