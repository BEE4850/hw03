...
* Plot the median and 95% credible intervals for the hindcasts and the projections under RCP 8.5 (using `ERF_ssp585_1750-2500.csv`; make sure $T_0$ and $H_0$ have the same meaning as in Problem 1!). 
